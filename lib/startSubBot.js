...
async function startSubBot(client, m, userNumber) {
    ...
    sock.ev.on("messages.upsert", async (chatUpdate) => {
        try {
            ...
            // Ahora smsg funcionará porque sock.decodeJid ya existe
    ...
    sock.ev.on("connection.update", async (update) => {
        ...
        if (connection === "close") {
            ...
            await client.sendMessage(m.chat, { text: `✅ Sub-bot [${userNumber}] activo y respondiendo comandos.` });
        }
    });
